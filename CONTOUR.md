...
- Canonical runner impl: `scripts/_psr_impl.py` (readable Python source of truth).
- Entry points: `scripts/test_polybtc_session_exit_sl.py` → `polybtc_session_runner.main` → `_psr_impl.main`.
